...
class TasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task" do
    post category_tasks_path(@category), params: { task: { title: "Testing one", 
  ...
  test "should go to all tasks from update task" do
    patch category_task_path(@category, @task), params: { task: { title: "Title this", content: "Content this" } }
